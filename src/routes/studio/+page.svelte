...
<svelte:head>
	<title>RSTR studio — turn your images into unique art</title>
</svelte:head>
...
<style>
	...
	/* Full-viewport app shell in the d17e.dev brand. The UI itself stays
	   neutral (inks and greys) so the art can shine; the brand CMY lives in
	   the artwork and the default pens. */
	.app {
		/* d17e.dev palette */
		--ink: #1a202c;
		--ink-soft: #2d3748;
