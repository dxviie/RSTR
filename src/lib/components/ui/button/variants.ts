...
// Kept separate from index.ts so button.svelte can import the variants
// without going through index.ts (which imports button.svelte back —
// a circular import that breaks Vite SSR module evaluation).
